...
public class HttpUtil {
	...
	private static void sendGetHttp() throws Exception {
		String url = "";
	...
	public static void httpCore() throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "http://10.2.15.5:8983/solr/article-repo/select?q=*%3A*&start=12&rows=2&wt=json&indent=true";
		HttpUtil.getHttp(url);
	}
}